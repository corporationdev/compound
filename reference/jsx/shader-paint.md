...
- WGSL compile errors are reported on the app console ([`compound logs`](../logs.md)) with line numbers relative to your source; the paint renders as passthrough until a fix lands.
