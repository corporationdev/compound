...
| ---- | ---- | ------- | ------- |
| `id` | `string` | stamped | How the element is addressed — by the editor writing back to it, by `compound capture`, by [`syncTo`](./audio-sync.md). Written into your source if you leave it out (see [module.md](./module.md#ids)). |
