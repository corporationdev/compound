...
component system in the Compound app.

## Logos

| File | Use |
| --- | --- |
| `assets/logos/icon-white.svg` | The Compound mark, on a dark, quiet background |

No wordmark and no dark mark are bundled. Set the product name in type when it must be clear.
