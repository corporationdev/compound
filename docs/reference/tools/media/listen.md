...
Compound routes this through Gemini on Compound’s Cloudflare Worker. Prepared media is limited to 100 MiB and requests time out after four minutes; choose a shorter window for large files.

| | |
| --- | --- |
| MCP tool | `media_listen` |
| CLI | `compound media listen <path> [options]` |
