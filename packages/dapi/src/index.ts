...
import type { LibraryItem as LibraryItemSchema, LibraryKind as LibraryKindSchema } from "./tools/library";
...
export type LibraryKind = z.output<typeof LibraryKindSchema>;
...
export type ProjectsListResult = ToolOutput<"projects_list">;
export type LibrarySearchRequest = ToolArgs<"library_search">;
export type LibraryImportResult = ToolOutput<"library_import">;
