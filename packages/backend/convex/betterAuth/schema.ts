/**
 * Local install of the Better Auth component schema.
 *
 * The base tables are copied verbatim from
 * @convex-dev/better-auth/src/component/schema.ts (0.12.5). The session
 * `activeOrganizationId` field and the organization, member and invitation
 * tables come from the organization plugin (teams disabled). Keep this in
 * sync by hand when the component or plugin set changes.
 */
...
export const tables = {
  ...
  // Organization plugin (teams disabled).
